...
str(Top5)
```
There are 177510 observations in the Top5 locations
...
11595 / (11595 + 144969)  
```
Gas Station has much higher arrest rate than the other locations.


Problem 4.4 - Popular Locations
On which day of the week do the most motor vehicle thefts at gas stations happen?
```{r}
gas_station_arrest <- subset(Top5, LocationDescription=="GAS STATION")
table(gas_station_arrest$Arrest, gas_station_arrest$Weekday)
```
...
```{r}
gas_station_arrest <- subset(Top5, LocationDescription=="DRIVEWAY - RESIDENTIAL")
table(gas_station_arrest$Arrest, gas_station_arrest$Weekday)
```
the fewest motor vehicle thefts in residential driveways happen on Saturday
